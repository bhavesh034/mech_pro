                    ...
                    <div class="row align-items-center">
                        <div class="col flex-horizontal-center">
                            <img class="icon-email"
                                src="{{ asset('assets/frontend/imgs/theme/icons/icon-email.svg') }}"
                                alt="">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="widget-about font-md mb-md-5 mb-lg-0">
                        <div class="logo logo-width-1 wow fadeIn animated">
                            <a href="index.html"><img src="{{ asset('assets/frontend/imgs/theme/logo.svg') }}"
                                    alt="logo"></a>
                        </div>
                        ...
                        <div class="mobile-social-icon wow fadeIn animated mb-sm-5 mb-md-0">
                            ...
                            <a href="#"><img
                                    ...
                                    alt=""></a>
                            <a href="#"><img
                                    src="{{ asset('assets/frontend/imgs/theme/icons/icon-youtube.svg') }}"
                                    alt=""></a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-md-8 col-lg-12">
                            ...
                            <div class="download-app wow fadeIn animated">
                                ...
                                <a href="#" class="hover-up"><img
                                        src="{{ asset('assets/frontend/imgs/theme/google-play.jpg') }}"
                                        alt=""></a>
                            </div>
                        </div>
