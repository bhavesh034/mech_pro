                        ...
                        <div class="col-lg-7 col-md-6">
                            <div class="single-slider-img single-slider-img-1">
                                <img class="animated slider-1-1"
                                    src="{{ asset('assets/frontend/imgs/slider/slider-1.png') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-7 col-md-6">
                            <div class="single-slider-img single-slider-img-1">
                                <img class="animated slider-1-2"
                                    src="{{ asset('assets/frontend/imgs/slider/slider-2.png') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-7 col-md-6">
                            <div class="single-slider-img single-slider-img-1">
                                <img class="animated slider-1-3"
                                    src="{{ asset('assets/frontend/imgs/slider/slider-3.png') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="product-cart-wrap mb-xs-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img"
                                                src="{{ asset('assets/frontend/imgs/shop/product-6-1.jpg') }}"
                                                alt="">
                                            <img class="hover-img"
                                                src="{{ asset('assets/frontend/imgs/shop/product-6-2.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img"
                                                src="{{ asset('assets/frontend/imgs/shop/product-11-1.jpg') }}"
                                                alt="">
                                            <img class="hover-img"
                                                src="{{ asset('assets/frontend/imgs/shop/product-11-2.jpg') }}"
                                                alt="">
                                        </a>
                                    </div>
                                    <div class="product-action-1">
    ...
    <section class="banner-2 section-padding pb-0">
        <div class="container">
            <div class="banner-img banner-big wow fadeIn animated f-none">
                <img src="{{ asset('assets/frontend/imgs/banner/banner-4.png') }}" alt="">
            ...
            <div class="carausel-6-columns-cover position-relative">
                ...
                <div class="carausel-6-columns" id="carausel-6-columns">
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img
                                    src="{{ asset('assets/frontend/imgs/shop/category-thumb-1.jpg') }}"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"> <img
                                    src="{{ asset('assets/frontend/imgs/shop/category-thumb-2.jpg') }}"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img
                                    src="{{ asset('assets/frontend/imgs/shop/category-thumb-3.jpg') }}"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img
                                    src="{{ asset('assets/frontend/imgs/shop/category-thumb-4.jpg') }}"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img
                                    src="{{ asset('assets/frontend/imgs/shop/category-thumb-5.jpg') }}"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img
                                    src="{{ asset('assets/frontend/imgs/shop/category-thumb-6.jpg') }}"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img
                                    src="{{ asset('assets/frontend/imgs/shop/category-thumb-7.jpg') }}"
                                    alt=""></a>
                        </figure>
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img
                                    src="{{ asset('assets/frontend/imgs/shop/category-thumb-8.jpg') }}"
                                    alt=""></a>
                        </figure>
            ...
            <div class="row">
                <div class="col-lg-6 deal-co">
                    <div class="deal wow fadeIn animated mb-md-4 mb-sm-4 mb-lg-0"
                        style="background-image: url('assets/frontend/imgs/banner/menu-banner-7.jpg');">
                        <div class="deal-top">
                ...
                <div class="col-lg-6 deal-co">
                    <div class="deal wow fadeIn animated"
                        style="background-image: url('assets/frontend/imgs/banner/menu-banner-8.jpg');">
                        <div class="deal-top">
                ...
                <div class="carausel-6-columns text-center" id="carausel-6-columns-3">
                    <div class="brand-logo">
                        <img class="img-grey-hover"
                            src="{{ asset('assets/frontend/imgs/banner/brand-1.png') }}" alt="">
                    </div>
                    <div class="brand-logo">
                        <img class="img-grey-hover"
                            src="{{ asset('assets/frontend/imgs/banner/brand-2.png') }}" alt="">
                    </div>
                    <div class="brand-logo">
                        <img class="img-grey-hover"
                            src="{{ asset('assets/frontend/imgs/banner/brand-3.png') }}" alt="">
                    </div>
                    <div class="brand-logo">
                        <img class="img-grey-hover"
                            src="{{ asset('assets/frontend/imgs/banner/brand-4.png') }}" alt="">
                    </div>
                    <div class="brand-logo">
                        <img class="img-grey-hover"
                            src="{{ asset('assets/frontend/imgs/banner/brand-5.png') }}" alt="">
                    </div>
                    <div class="brand-logo">
                        <img class="img-grey-hover"
                            src="{{ asset('assets/frontend/imgs/banner/brand-6.png') }}" alt="">
                    </div>
                    <div class="brand-logo">
                        <img class="img-grey-hover"
                            src="{{ asset('assets/frontend/imgs/banner/brand-3.png') }}" alt="">
                    ...
                    <div class="post-list mb-4 mb-lg-0">
                            ...
                            <div class="d-md-flex d-block">
                                <div class="post-thumb d-flex mr-15">
                                    <a class="color-white" href="blog-post-fullwidth.html">
                                        <img src="{{ asset('assets/frontend/imgs/blog/blog-2.jpg') }}"
                                            alt="">
                                    </a>
                                </div>
                                <div class="post-content">
                                    ...
                                    <div class="entry-meta meta-1 font-xs color-grey mt-10 pb-10">
                                        <div>
                                            <span class="post-on">14 April 2021</span>
                        ...
                        <article class="wow fadeIn animated">
                            <div class="d-md-flex d-block">
                                <div class="post-thumb d-flex mr-15">
                                    <a class="color-white" href="blog-post-fullwidth.html">
                                        <img src="{{ asset('assets/frontend/imgs/blog/blog-1.jpg') }}"
                                            alt="">
                                    </a>
                                </div>
                                <div class="post-content">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="banner-img banner-1 wow fadeIn animated">
                                <img src="{{ asset('assets/frontend/imgs/banner/banner-5.jpg') }}"
                                    alt="">
                                <div class="banner-text">
                        ...
                        <div class="col-md-6">
                            <div class="banner-img mb-15 wow fadeIn animated">
                                <img src="{{ asset('assets/frontend/imgs/banner/banner-6.jpg') }}"
                                    alt="">
                                <div class="banner-text">
                                    <span>Big Offer</span>
                            ...
                            <div class="banner-img banner-2 wow fadeIn animated">
                                <img src="{{ asset('assets/frontend/imgs/banner/banner-7.jpg') }}"
                                    alt="">
                                <div class="banner-text">
                                    <span>Smart Offer</span>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="banner-bg wow fadeIn animated"
                        style="background-image: url('assets/frontend/imgs/banner/banner-8.jpg')">
